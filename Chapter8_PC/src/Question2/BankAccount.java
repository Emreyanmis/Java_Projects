...
public class BankAccount
{
	...
	*/
	...
	{  
		// Create a new BankAccount object and initialize it with the same data held by 
		// the same data held by the calling object
		BankAccount copyObject = new BankAccount(balance);
