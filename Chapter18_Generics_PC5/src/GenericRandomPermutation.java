...
public class GenericRandomPermutation <T>
{
   public static void main(String[] args)
   {
      // Create a random subsets object specialized for strings
	  Subsets<Integer> inSubsets = new Subsets<>(); 
      Subsets<String> strSubsets = new Subsets<>();
      
      Integer[] numbers = { 2, 4,5,6,7,3,8};
      ...
      System.out.println(inSubsets.getRandomSubset(numbersList));
      System.out.println(inSubsets.getRandomSubset(numbersList));
      System.out.println(inSubsets.getRandomSubset(numbersList));
   }
}
