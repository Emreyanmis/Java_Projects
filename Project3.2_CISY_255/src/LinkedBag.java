...
public class LinkedBag<E extends Comparable <E>> 
{
    ...
    */
    public void add(E newElement)
    {
          ...
          Node<E> i = new  Node<E>(newElement, null);

         if (tail == null)
         {
         head = i; // head switch into a node
         tail = head;
         }
         
     else
      {
               Node<E> current = head;   // makes the current cursor to head
               Node<E> previous = null;  // makes the previous cursor to null
