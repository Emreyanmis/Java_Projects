...
public class BinarySearchTree extends BinaryTree
{
 ...
 private Node add(int x, Node bstree)
 {
     ...
     if(x < bstree.value)
     {	 
       //Add x to the left subtree and replace the current left subtree with the result
   ...
   */
     ...
     public boolean remove(int x)
     {
      ...
      /**
       * This remove method removes a value from a binary search tree and returns the removed node
